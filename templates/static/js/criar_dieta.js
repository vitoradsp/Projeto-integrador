...
function macros_refeicao(numero_da_ref) {
  switch(Number(numero_da_ref)){
    case 1:
      ...
      let kcal_1=document.querySelector('#kcal_total_row1_ref_1').innerText;
      let prot_1=document.querySelector('#prot_total_row1_ref_1').innerText;
      let gord_1=document.querySelector('#gord_total_row1_ref_1').innerText;
      let carb_1=document.querySelector('#carb_total_row1_ref_1').innerText;
      let quantidade_1=document.querySelector('#quanti_row1_ref_1').value;
    ...
    case 2:
      /*valores alimento 1 */
      let kcal_4=document.querySelector('#kcal_total_row1_ref_2').innerText;
      let prot_4=document.querySelector('#prot_total_row1_ref_2').innerText;
      let gord_4=document.querySelector('#gord_total_row1_ref_2').innerText;
      let carb_4=document.querySelector('#carb_total_row1_ref_2').innerText;
      let quantidade_4=document.querySelector('#quanti_row1_ref_2').value;
    ...
    case 3:
      /*valores alimento 1 */
      let kcal_7=document.querySelector('#kcal_total_row1_ref_3').innerText;
      let prot_7=document.querySelector('#prot_total_row1_ref_3').innerText;
      let gord_7=document.querySelector('#gord_total_row1_ref_3').innerText;
      let carb_7=document.querySelector('#carb_total_row1_ref_3').innerText;
      let quantidade_7=document.querySelector('#quanti_row1_ref_3').value;
      ...
      /*valores alimento 2 */
      let kcal_8=document.querySelector('#kcal_total_row2_ref_3').innerText;
      let prot_8=document.querySelector('#prot_total_row2_ref_3').innerText;
      let gord_8=document.querySelector('#gord_total_row2_ref_3').innerText;
      let carb_8=document.querySelector('#carb_total_row2_ref_3').innerText;
      let quantidade_8=document.querySelector('#quanti_row2_ref_3').value;
      ...
      /*valores alimento 3 */
      let kcal_9=document.querySelector('#kcal_total_row3_ref_3').innerText;
      let prot_9=document.querySelector('#prot_total_row3_ref_3').innerText;
      let gord_9=document.querySelector('#gord_total_row3_ref_3').innerText;
      let carb_9=document.querySelector('#carb_total_row3_ref_3').innerText;
      let quantidade_9=document.querySelector('#quanti_row3_ref_3').value;
    ...
    case 4:
      /*valores alimento 1 */
      let kcal_10=document.querySelector('#kcal_total_row1_ref_4').innerText;
      let prot_10=document.querySelector('#prot_total_row1_ref_4').innerText;
      let gord_10=document.querySelector('#gord_total_row1_ref_4').innerText;
      let carb_10=document.querySelector('#carb_total_row1_ref_4').innerText;
      let quantidade_10=document.querySelector('#quanti_row1_ref_4').value;
      ...
      /*valores alimento 2 */
      let kcal_11=document.querySelector('#kcal_total_row2_ref_4').innerText;
      let prot_11=document.querySelector('#prot_total_row2_ref_4').innerText;
      let gord_11=document.querySelector('#gord_total_row2_ref_4').innerText;
      let carb_11=document.querySelector('#carb_total_row2_ref_4').innerText;
      let quantidade_11=document.querySelector('#quanti_row2_ref_4').value;
      ...
      /*valores alimento 3 */
      let kcal_12=document.querySelector('#kcal_total_row3_ref_4').innerText;
      let prot_12=document.querySelector('#prot_total_row3_ref_4').innerText;
      let gord_12=document.querySelector('#gord_total_row3_ref_4').innerText;
      let carb_12=document.querySelector('#carb_total_row3_ref_4').innerText;
      let quantidade_12=document.querySelector('#quanti_row3_ref_4').value;
    ...
    case 5 :
      /*valores alimento 1 */
      let kcal_13=document.querySelector('#kcal_total_row1_ref_5').innerText;
      let prot_13=document.querySelector('#prot_total_row1_ref_5').innerText;
      let gord_13=document.querySelector('#gord_total_row1_ref_5').innerText;
      let carb_13=document.querySelector('#carb_total_row1_ref_5').innerText;
      let quantidade_13=document.querySelector('#quanti_row1_ref_5').value;
      ...
      /*valores alimento 2 */
      let kcal_14=document.querySelector('#kcal_total_row2_ref_5').innerText;
      let prot_14=document.querySelector('#prot_total_row2_ref_5').innerText;
      let gord_14=document.querySelector('#gord_total_row2_ref_5').innerText;
      let carb_14=document.querySelector('#carb_total_row2_ref_5').innerText;
      let quantidade_14=document.querySelector('#quanti_row2_ref_5').value;
      ...
      /*valores alimento 3 */
      let kcal_15=document.querySelector('#kcal_total_row3_ref_5').innerText;
      let prot_15=document.querySelector('#prot_total_row3_ref_5').innerText;
      let gord_15=document.querySelector('#gord_total_row3_ref_5').innerText;
      let carb_15=document.querySelector('#carb_total_row3_ref_5').innerText;
      let quantidade_15=document.querySelector('#quanti_row3_ref_5').value;
    ...
    case 6 :
      /*valores alimento 1 */
      let kcal_16=document.querySelector('#kcal_total_row1_ref_6').innerText;
      let prot_16=document.querySelector('#prot_total_row1_ref_6').innerText;
      let gord_16=document.querySelector('#gord_total_row1_ref_6').innerText;
      let carb_16=document.querySelector('#carb_total_row1_ref_6').innerText;
      let quantidade_16=document.querySelector('#quanti_row1_ref_6').value;
      ...
      /*valores alimento 2 */
      let kcal_17=document.querySelector('#kcal_total_row2_ref_6').innerText;
      let prot_17=document.querySelector('#prot_total_row2_ref_6').innerText;
      let gord_17=document.querySelector('#gord_total_row2_ref_6').innerText;
      let carb_17=document.querySelector('#carb_total_row2_ref_6').innerText;
      let quantidade_17=document.querySelector('#quanti_row2_ref_6').value;
      ...
      /*valores alimento 3 */
      let kcal_18=document.querySelector('#kcal_total_row3_ref_6').innerText;
      let prot_18=document.querySelector('#prot_total_row3_ref_6').innerText;
      let gord_18=document.querySelector('#gord_total_row3_ref_6').innerText;
      let carb_18=document.querySelector('#carb_total_row3_ref_6').innerText;
      let quantidade_18=document.querySelector('#quanti_row3_ref_6').value;
